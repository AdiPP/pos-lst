...
<head>
    ...
    <style>
        ...
        #jumlahprodukparent input,
        #hargabeliparent input {
            margin: 0;
...
<body class="fixed-header horizontal-menu horizontal-app-menu dashboard">
        ...
        <div class="header-inner header-md-height">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown pull-right">
                    <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true"
                        ...
                        <span class="thumbnail-wrapper d32 circular inline sm-m-r-5">
                            <a href="#"><img src="{{ asset('assets/img/profiles/avatar.jpg') }}" alt=""
              ...
              <a href="#" class="clearfix bg-master-lighter dropdown-item">
                ...
                <!-- END User Info-->
                <a href="/logout" class=""><i class="header-icon m-l-10 fa fa-sign-out"
              ...
              @endif">
                    ...
                    @endif">
                            ...
                            <ul class="">
                                ...
                                <li class="">
                                    <a href="/pengaturan/harga">Harga</a>
                                </li>
                            </ul>
                        </li>
                        <li class="@if (config('global.active_nav') === 'pos')
                    ...
                    <a href="#" class="search-link d-flex justify-content-between align-items-center hidden-lg-up"
                                        ...
                                        <a data-view-animation="push-parrallax" data-view-port="#chat"
                                            ...
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt=""
                                                    data-src-retina="{{ asset('assets/img/profiles/1x.jpg') }}"
                                                    data-src="{{ asset('assets/img/profiles/1.jpg') }}"
                                                    src="{{ asset('assets/img/profiles/1x.jpg') }}" class="col-top">
                                            </span>
                                            <p class="p-l-10 ">
                                ...
                                <ul>
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat"
                                            ...
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt=""
                                                    data-src-retina="{{ asset('assets/img/profiles/2x.jpg') }}"
                                                    data-src="{{ asset('assets/img/profiles/2.jpg') }}"
                                                    src="{{ asset('assets/img/profiles/2x.jpg') }}" class="col-top">
                                            </span>
                                            <p class="p-l-10 ">
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat"
                                            ...
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt=""
                                                    data-src-retina="{{ asset('assets/img/profiles/3x.jpg') }}"
                                                    data-src="{{ asset('assets/img/profiles/3.jpg') }}"
                                                    src="{{ asset('assets/img/profiles/3x.jpg') }}" class="col-top">
                                            </span>
                                            <p class="p-l-10 ">
                                ...
                                <ul>
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat"
                                            ...
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt=""
                                                    data-src-retina="{{ asset('assets/img/profiles/4x.jpg') }}"
                                                    data-src="{{ asset('assets/img/profiles/4.jpg') }}"
                                                    src="{{ asset('assets/img/profiles/4x.jpg') }}" class="col-top">
                                            </span>
                                            <p class="p-l-10 ">
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat"
                                            ...
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt=""
                                                    data-src-retina="{{ asset('assets/img/profiles/5x.jpg') }}"
                                                    data-src="{{ asset('assets/img/profiles/5.jpg') }}"
                                                    src="{{ asset('assets/img/profiles/5x.jpg') }}" class="col-top">
                                            </span>
                                            <p class="p-l-10 ">
                                ...
                                <ul>
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat"
                                            ...
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt=""
                                                    data-src-retina="{{ asset('assets/img/profiles/6x.jpg') }}"
                                                    data-src="{{ asset('assets/img/profiles/6.jpg') }}"
                                                    src="{{ asset('assets/img/profiles/6x.jpg') }}" class="col-top">
                                            </span>
                                            <p class="p-l-10 ">
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat"
                                            ...
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt=""
                                                    data-src-retina="{{ asset('assets/img/profiles/7x.jpg') }}"
                                                    data-src="{{ asset('assets/img/profiles/7.jpg') }}"
                                                    src="{{ asset('assets/img/profiles/7x.jpg') }}" class="col-top">
                                            </span>
                                            <p class="p-l-10 ">
                                ...
                                <ul>
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat"
                                            ...
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt=""
                                                    data-src-retina="{{ asset('assets/img/profiles/8x.jpg') }}"
                                                    data-src="{{ asset('assets/img/profiles/8.jpg') }}"
                                                    src="{{ asset('assets/img/profiles/8x.jpg') }}" class="col-top">
                                            </span>
                                            <p class="p-l-10 ">
                                    ...
                                    <li class="chat-user-list clearfix">
                                        <a data-view-animation="push-parrallax" data-view-port="#chat"
                                            ...
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt=""
                                                    data-src-retina="{{ asset('assets/img/profiles/9x.jpg') }}"
                                                    data-src="{{ asset('assets/img/profiles/9.jpg') }}"
                                                    src="{{ asset('assets/img/profiles/9x.jpg') }}" class="col-top">
                                            </span>
                                            <p class="p-l-10 ">
                            ...
                            <div class="message clearfix">
                                <div class="profile-img-wrapper m-t-5 inline">
                                    <img class="col-top" width="30" height="30"
                                        src="{{ asset('assets/img/profiles/avatar_small.jpg') }}" alt=""
                                        data-src="{{ asset('assets/img/profiles/avatar_small.jpg') }}"
                                        data-src-retina="{{ asset('assets/img/profiles/avatar_small2x.jpg') }}">
                                </div>
    ...
    {{-- <div class="overlay hide" data-pages="search">
      ...
      <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
          <!-- BEGIN Overlay Logo !-->
          <img class="overlay-brand" src="{{ asset('assets/img/logo.png') }}" alt="logo"
    data-src="{{ asset('assets/img/logo.png') }}" data-src-retina="{{ asset('assets/img/logo_2x.png') }}" width="78"
    height="22">
    <!-- END Overlay Logo !-->
    <!-- BEGIN Overlay Close !-->
                ...
                <div class="col-md-6">
                    ...
                    <div class="">
                        ...
                        <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                            <div>
                                <img width="50" height="50" src="{{ asset('assets/img/profiles/avatar.jpg') }}"
                                    data-src="{{ asset('assets/img/profiles/avatar.jpg') }}"
                                    data-src-retina="{{ asset('assets/img/profiles/avatar2x.jpg') }}" alt="">
                            </div>
                        </div>
    ...
    <script type="text/javascript" src=" {{ asset('assets/plugins/datatables-responsive/js/lodash.min.js') }} ">
    </script>
    {{-- FORM JS --}}
    ...
    <script type="text/javascript" src=" {{ asset('assets/plugins/bootstrap-tag/bootstrap-tagsinput.min.js') }} ">
    </script>
    <script type="text/javascript" src=" {{ asset('assets/plugins/jquery-inputmask/jquery.inputmask.min.js') }} ">
    </script>
