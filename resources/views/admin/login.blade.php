  ...
  <body class="fixed-header ">
    <div class="register-container full-height sm-p-t-30">
      <div class="d-flex justify-content-center flex-column full-height ">
        <h5 class="bold">Sade POS</h5>
        {{-- <img src="assets/img/logo.png" alt="logo" data-src="b{{ asset('assets/img/logo.png') }}" data-src-retina="{{ asset('assets/img/logo_2x.png') }}" width="78" height="22"> --}}
        <h3>Super Admin Panel</h3>
        <p>
            Panel login khusus Super Admin - PT. Lawang Sewu Teknologi.
        </p>
        <form id="form-register" class="p-t-15" role="form" action="/admin/login/proses" method="POST">
        @csrf
          <div class="row">
            <div class="col-md-12">
              <div class="form-group form-group-default">
                <label>Username</label>
                <input type="text" name="username" placeholder="yourname.pages.com (this can be changed later)" class="form-control" required>
              </div>
            </div>
          </div>
          <div class="row">
      ...
      <div class="register-container m-b-10 clearfix">
        <div class="m-b-30 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix d-flex-md-up">
          <div class="col-md-2 no-padding d-flex align-items-center">
            <img src="{{ asset('assets/img/demo/pages_icon.png') }}" alt="" class="" data-src="{{ asset('assets/img/demo/pages_icon.png') }}" data-src-retina="{{ asset('assets/img/demo/pages_icon_2x.png') }}" width="60" height="60">
          </div>
