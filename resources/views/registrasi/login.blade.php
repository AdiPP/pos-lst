        ...
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
          ...
          <form id="form-login" class="p-t-15" role="form" action="/login/action" method="POST">
            ...
            <div class="row m-t-10">
                <div class="col-lg-5">
                    <button class="btn btn-primary btn-cons pull-left" type="submit">Masuk</button>
                </div>
                <div class="col-lg-2 text-center align-self-center">
                    atau
                </div>
                <div class="col-lg-5">
                    <a href="/registrasi" class="btn btn-cons pull-right" >Daftar</a>
                </div>
            </div>
          </form>
          <!--END Login Form-->
