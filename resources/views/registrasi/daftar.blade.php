  ...
  <body class="fixed-header ">
    <div class="register-container full-height sm-p-t-30">
      <div class="d-flex justify-content-center flex-column full-height ">
        ...
        <p>
            Nikmati kebebasan mengelola bisnis dari mana saja dengan aplikasi kasir online POSLST. Mulai sekarang.
        ...
        @csrf
          ...
          <div class="row m-t-10">
            <div class="col-lg-6">
              <p><small>Saya setuju dengan <a href="#" class="text-info">Syarat</a> & <a href="#" class="text-info">Ketentuan</a>.</small></p>
            </div>
            <div class="col-lg-6 text-right">
              <a href="#" class="text-info small">Bantuan? Hubungi Kami</a>
            </div>
          </div>
          <button class="btn btn-primary btn-cons m-t-10" type="submit">Buat akun baru</button>
        </form>
      </div>
    </div>
